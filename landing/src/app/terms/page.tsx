  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-32 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl lg:text-5xl font-black text-black mb-12 tracking-[-0.05em]">Terms of Service</h1>
        <p className="text-black/50 mb-8 italic">Effective Date: April 2026</p>
        ...
        <div className="prose prose-lg prose-slate max-w-none space-y-12 text-black/75">
          ...
          <section>
            <h2 className="text-2xl font-bold text-black mb-4">4. Subscription & Payments</h2>
            <p>
