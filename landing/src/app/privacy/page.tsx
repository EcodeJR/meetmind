  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-32 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl lg:text-5xl font-bold text-primary mb-12 tracking-tight">Privacy Policy</h1>
        ...
        <div className="prose prose-lg prose-slate max-w-none space-y-12 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">3. Data Storage & Infrastructure</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">4. Third-Party Intelligence Services</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">5. User Rights & Data Governance</h2>
